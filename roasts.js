const roasts = [
        ...
        `is huge in mass.`,
        `Is big and round`,
        `has their own center of mass`,
        `is morbidly a beast`,
        `'s pronouns are lbs/kg/tons.`,
        `is usagi.`,
        `will eventually turn into a star with their mass`,
        `has their own gravitational force`,
        `is huge in mass.`,
        `has an orbit around them`,
        `is Fat Bald Friend.`,
