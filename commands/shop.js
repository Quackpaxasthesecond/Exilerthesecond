module.exports = {
  ...
  execute: async (message, args, context) => {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
  { name: 'xp_multiplier', value: 'x2 XP for 60 minutes  Cost: 2,000 hi', inline: false },
  { name: 'extra_luck', value: '+10% gamble luck for 60 minutes  Cost: 600 hi', inline: false },
      { name: 'random_exile', value: 'Exile a random eligible member for 10 minutes  Cost: 5,000 hi', inline: false },
